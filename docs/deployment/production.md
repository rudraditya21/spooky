...
# Applies routes/upstreams/backends/limits/policies and log.level live; log format/file settings,
# tracing config, thread counts, and listener bind/removal changes still require a full restart.
